"""Tests for G2 target hygiene audit helpers."""
...
def _load_script_module():
    path = Path(__file__).resolve().parent.parent / "scripts" / "audit_g2_target_hygiene.py"
    spec = spec_from_file_location("audit_g2_target_hygiene", path)
