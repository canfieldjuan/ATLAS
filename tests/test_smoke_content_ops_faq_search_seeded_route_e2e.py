...
SAAS_DEMO_RUNBOOK = ROOT / "docs/extraction/validation/content_ops_faq_saas_demo_route_case_runbook.md"
...
def test_host_runbook_links_saas_demo_route_case_validation_runbook():
    doc = HOST_RUNBOOK.read_text(encoding="utf-8")
    relative_path = "docs/extraction/validation/content_ops_faq_saas_demo_route_case_runbook.md"

    assert relative_path in doc
    assert SAAS_DEMO_RUNBOOK.exists()
