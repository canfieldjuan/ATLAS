"""Tests for Gartner raw capture audit script helpers."""
...
def _load_script_module():
    path = Path(__file__).resolve().parent.parent / "scripts" / "audit_gartner_raw_capture.py"
    spec = spec_from_file_location("audit_gartner_raw_capture", path)
