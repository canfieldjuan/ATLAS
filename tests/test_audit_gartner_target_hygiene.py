"""Tests for Gartner target hygiene audit helpers."""
...
def _load_script_module():
    path = Path(__file__).resolve().parent.parent / "scripts" / "audit_gartner_target_hygiene.py"
    spec = spec_from_file_location("audit_gartner_target_hygiene", path)
