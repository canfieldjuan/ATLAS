"""Tests for Trustpilot raw capture audit script helpers."""
...
def _load_script_module():
    path = Path(__file__).resolve().parent.parent / "scripts" / "audit_trustpilot_raw_capture.py"
    spec = spec_from_file_location("audit_trustpilot_raw_capture", path)
