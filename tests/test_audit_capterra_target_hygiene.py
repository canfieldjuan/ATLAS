"""Tests for Capterra target hygiene audit helpers."""
...
def _load_script_module():
    path = Path(__file__).resolve().parent.parent / "scripts" / "audit_capterra_target_hygiene.py"
    spec = spec_from_file_location("audit_capterra_target_hygiene", path)
