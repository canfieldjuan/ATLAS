"""Read-only report draft export helpers for AI Content Ops hosts."""
...
async def export_report_drafts(
    ...
    *,
    ...
    """Return generated report drafts for host review/export workflows."""
    ...
    return ReportDraftExportResult(
...
def _draft_row(draft: ReportDraft) -> JsonDict:
    row = draft.as_dict()
