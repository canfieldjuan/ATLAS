...
class ContentOpsExecutionServices:
    ...
    def with_reasoning_context(
        ...
        return ContentOpsExecutionServices(
            ...
            # stat_card stays as-is; it does not consume reasoning.
            stat_card=self.stat_card,
