...
export type DeflectionReportSection =
  | DeflectionReportSupportTaxSection
  | DeflectionReportSourceFileSection
  | DeflectionReportSeoTargetsSection
  | DeflectionReportRankedQuestionsSection
  | DeflectionReportPriorityFixQueueSection
  | DeflectionReportTopUnresolvedRepeatsSection
  | DeflectionReportDraftedResolutionsSection
