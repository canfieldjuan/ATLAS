...
logger = logging.getLogger("extracted_competitive_intelligence.autonomous.tasks._b2b_batch_utils")
...
def resolve_anthropic_batch_llm(
    *,
    ...
    llm_registry = _load_llm_registry()
