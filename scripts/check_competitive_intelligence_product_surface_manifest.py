#!/usr/bin/env python3
"""Validate the non-Python competitive-intelligence product surface manifest."""
...
def main(argv=None):
    parser = argparse.ArgumentParser(
        description="Check the non-Python competitive-intelligence product surface manifest."
    )
    ...
    print("competitive intelligence product surface manifest ok: %d file(s)" % len(discovered))
    return 0
