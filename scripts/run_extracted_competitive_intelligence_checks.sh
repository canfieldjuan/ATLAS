...
python -m pytest tests/test_extracted_competitive_manifest.py tests/test_extracted_competitive_cross_vendor_selection.py tests/test_extracted_competitive_prompt_contracts.py -q
