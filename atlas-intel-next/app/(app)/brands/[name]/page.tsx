...
import { PIE_COLORS, TOOLTIP_STYLE, CHURN_COLORS, DistBar, BadgeRow, Card } from '@/components/BrandComponents'
      ...
      {tab === 'products' && (
        <div className="bg-slate-900/50 border border-slate-700/50 backdrop-blur rounded-xl overflow-hidden">
          <DataTable
            ...
            data={data.products}
            onRowClick={(r) => router.push(`/reviews?asin=${encodeURIComponent(r.asin)}`)}
