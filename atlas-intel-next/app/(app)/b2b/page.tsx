...
import { fetchOverview, fetchTrackedVendors, type DashboardOverview, type TrackedVendor } from '@/lib/api/b2bClient'
    ...
    <div className="space-y-6">
      ...
      <div className="bg-slate-900/50 border border-slate-700/50 rounded-xl p-4">
        <div className="flex items-center justify-between mb-3">
          ...
          <button
            onClick={() => router.push('/b2b/onboarding')}
        ...
        <DataTable
          ...
          data={vendors}
          onRowClick={r => router.push(`/b2b/signals/${encodeURIComponent(r.vendor_name)}`)}
          skeletonRows={skeleton ? 3 : undefined}
          emptyMessage="No vendors tracked yet"
          emptyAction={{ label: 'Add vendors', onClick: () => router.push('/b2b/onboarding') }}
        />
      </div>
      ...
      {(isChallenger || (overview?.recent_leads?.length ?? 0) > 0) && (
        <div className="bg-slate-900/50 border border-slate-700/50 rounded-xl p-4">
          ...
          <DataTable
            ...
            onRowClick={r => router.push(`/b2b/leads/${encodeURIComponent(r.company)}`)}
            skeletonRows={skeleton ? 3 : undefined}
