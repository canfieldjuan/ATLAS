...
import { fetchVendorDetail, type VendorDetail as VendorDetailType } from '@/lib/api/b2bClient'
  ...
  if (error) {
    return (
      <div className="space-y-4">
        <button onClick={() => router.back()} className="flex items-center gap-1 text-sm text-slate-400 hover:text-white">
