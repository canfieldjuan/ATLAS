...
| SYS-017 | Medium | B2B product/plan gate split | Tenant routes are protected from anonymous access, but many use `require_auth` rather than `require_b2b_plan`. Product-surface slices closed: competitive-set list/create/update/delete/preview/run, tracked-vendor list/add/remove/search/refresh, watchlist saved-view/alert controls, tenant report list/detail/generation, report-subscription controls, CRM push, opportunity disposition controls, and tenant exports now require `b2b_growth` before repo/DB/service touch. Frontend `usePlanGate` hides some UI, but direct API access still needs endpoint-by-endpoint backend enforcement. | `atlas_brain/api/b2b_tenant_dashboard.py:1177`, `atlas_brain/api/b2b_tenant_dashboard.py:1270`, `atlas_brain/api/b2b_tenant_dashboard.py:1384`, `atlas_brain/api/b2b_tenant_dashboard.py:1425`, `atlas_brain/api/b2b_tenant_dashboard.py:1459`, `atlas_brain/api/b2b_tenant_dashboard.py:1549`, `atlas_brain/api/b2b_tenant_dashboard.py:1567`, `atlas_brain/api/b2b_tenant_dashboard.py:1603`, `atlas_brain/api/b2b_tenant_dashboard.py:1656`, `atlas_brain/api/b2b_tenant_dashboard.py:1670`, `atlas_brain/api/b2b_tenant_dashboard.py:1694`, `atlas_brain/api/b2b_tenant_dashboard.py:2302`, `atlas_brain/api/b2b_tenant_dashboard.py:2335`, `atlas_brain/api/b2b_tenant_dashboard.py:2415`, `atlas_brain/api/b2b_tenant_dashboard.py:2594`, `atlas_brain/api/b2b_tenant_dashboard.py:2618`, `atlas_brain/api/b2b_tenant_dashboard.py:2666`, `atlas_brain/api/b2b_tenant_dashboard.py:2689`, `atlas_brain/api/b2b_tenant_dashboard.py:2743`, `atlas_brain/api/b2b_tenant_dashboard.py:3513`, `atlas_brain/api/b2b_tenant_dashboard.py:3549`, `atlas_brain/api/b2b_tenant_dashboard.py:3576`, `atlas_brain/api/b2b_tenant_dashboard.py:3599`, `atlas_brain/api/b2b_tenant_dashboard.py:3662`, `atlas_brain/api/b2b_tenant_dashboard.py:3773`, `atlas_brain/api/b2b_tenant_dashboard.py:3971`, `atlas_brain/api/b2b_tenant_dashboard.py:4074`, `atlas_brain/api/b2b_tenant_dashboard.py:4108`, `atlas_brain/api/b2b_tenant_dashboard.py:4384`, `atlas_brain/api/b2b_tenant_dashboard.py:4401`, `atlas_brain/api/b2b_tenant_dashboard.py:4424`, `atlas_brain/api/b2b_tenant_dashboard.py:4443`, `atlas_brain/api/b2b_tenant_dashboard.py:4659`, `atlas_brain/api/b2b_tenant_dashboard.py:4707`, `atlas_brain/api/b2b_tenant_dashboard.py:4748`, `atlas_brain/api/b2b_tenant_dashboard.py:4796`, `tests/test_b2b_access_boundaries.py:199`, `tests/test_b2b_access_boundaries.py:277` | Continue classifying remaining read/analytics endpoints by required tier. Keep `require_auth` only for account/profile routes that are intentionally universal. |
