...
| SYS-021 | High | Campaign management access boundary | Suppression mutations, suppression list/check, and sequence controls lived in `b2b_campaigns.py` without a product-plan dependency, so SaaS auth enabled did not protect global suppression state or sequence pause/resume/recipient changes. | `atlas_brain/api/b2b_campaigns.py:1160`, `atlas_brain/api/b2b_campaigns.py:1206`, `atlas_brain/api/b2b_campaigns.py:1234`, `atlas_brain/api/b2b_campaigns.py:1254`, `atlas_brain/api/b2b_campaigns.py:1855`, `atlas_brain/api/b2b_campaigns.py:1888`, `atlas_brain/api/b2b_campaigns.py:1914`, `tests/test_b2b_access_boundaries.py:313`, `tests/test_b2b_access_boundaries.py:518` | Suppression mutations, suppression list/check, and sequence-control mutations now require `b2b_growth` and are pinned in the access-boundary harness before DB touch. Remaining campaign reads (analytics, sequences, review-queue, and audit-log) still need plan and tenant-scope classification; the `campaign_suppressions` table remains a global blocklist by design, so future work should decide whether plan-gated global visibility is enough or account-scoped suppression state is required. |
