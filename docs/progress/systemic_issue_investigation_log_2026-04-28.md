...
| SYS-009 | High | Generic report renderers | Specialized report sections are ProductClaim-gated, but generic renderers still publish winner, weakness, recommendation, and displacement language from legacy fields. | `atlas-churn-ui/src/components/report-renderers/StructuredReportData.tsx:429`, `atlas-churn-ui/src/components/report-renderers/StructuredReportData.tsx:510`, `atlas-churn-ui/src/components/report-renderers/StructuredReportData.tsx:528`, `atlas-churn-ui/src/pages/Report.tsx:434` | Make dangerous generic keys fail closed unless gate metadata is present, or route those report families through specialized ProductClaim-aware view models. |
| SYS-018 | High | Specialized report renderer residuals | Patch 6 gated head-to-head and battle-card displacement reasoning, but adjacent specialized report sections still render category winners, cross-vendor winners, recommended plays, top displacement targets, and market winners from legacy view-model fields. | `atlas-churn-ui/src/components/report-renderers/SpecializedReportData.tsx:896`, `atlas-churn-ui/src/components/report-renderers/SpecializedReportData.tsx:1310`, `atlas-churn-ui/src/components/report-renderers/SpecializedReportData.tsx:1392`, `atlas-churn-ui/src/components/report-renderers/SpecializedReportData.tsx:1876`, `atlas-churn-ui/src/components/report-renderers/SpecializedReportData.tsx:2532` | Build a report-claim coverage matrix by view model. Any report section with winner/play/recommendation/displacement semantics should require ProductClaim gate context or render as legacy/unvalidated. |
