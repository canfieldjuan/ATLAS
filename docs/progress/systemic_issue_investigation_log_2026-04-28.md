...
| SYS-003 | High | CRM event ingestion and visibility | Generic CRM single/batch ingestion, native HubSpot/Salesforce/Pipedrive ingestion, and CRM event list/stats are now authenticated browser/operator APIs: they require auth before JSON/DB work, scope writes/reads by `account_id`, and preserve account ownership on upsert. The optional-auth native webhook surface is closed; true provider-native delivery still needs a separate signed-secret/API-key identity path. | `atlas_brain/api/b2b_crm_events.py:128`, `atlas_brain/api/b2b_crm_events.py:260`, `atlas_brain/api/b2b_crm_events.py:383`, `atlas_brain/api/b2b_crm_events.py:544`, `atlas_brain/api/b2b_crm_events.py:699`, `atlas_brain/api/b2b_crm_events.py:863`, `atlas_brain/api/b2b_crm_events.py:977`, `tests/test_b2b_access_boundaries.py:93`, `tests/test_b2b_crm_events.py:232`, `tests/test_b2b_crm_events.py:310`, `tests/test_b2b_crm_events.py:354` | Closed for browser/operator access boundary. Remaining product integration work is provider-native identity: split HubSpot/Salesforce/Pipedrive ingestion behind signed provider secrets or account-scoped API keys so real provider webhooks do not depend on a browser session. |
...
| SYS-021 | High | Campaign management access boundary | `b2b_campaigns.py` had a mixed boundary: some campaign management routes were plan-gated, while campaign list/stats/export/detail/audit-log, analytics, suppression state, review queues/candidates, sequence controls, and campaign-id mutation paths were anonymous, optional-auth, or id-scoped without proving tracked-vendor ownership despite SaaS auth being enabled. The router now has zero optional/no-dependency routes; customer-facing campaign reads and writes require `b2b_growth`, and campaign-id reads/writes scope through tracked vendors before returning data or mutating state. | `atlas_brain/api/b2b_campaigns.py:196`, `atlas_brain/api/b2b_campaigns.py:216`, `atlas_brain/api/b2b_campaigns.py:492`, `atlas_brain/api/b2b_campaigns.py:597`, `atlas_brain/api/b2b_campaigns.py:696`, `atlas_brain/api/b2b_campaigns.py:808`, `atlas_brain/api/b2b_campaigns.py:933`, `atlas_brain/api/b2b_campaigns.py:1004`, `atlas_brain/api/b2b_campaigns.py:1321`, `atlas_brain/api/b2b_campaigns.py:1525`, `atlas_brain/api/b2b_campaigns.py:1691`, `atlas_brain/api/b2b_campaigns.py:1851`, `atlas_brain/api/b2b_campaigns.py:2347`, `atlas_brain/api/b2b_campaigns.py:2409`, `atlas_brain/api/b2b_campaigns.py:2471`, `atlas_brain/api/b2b_campaigns.py:2603`, `atlas_brain/api/b2b_campaigns.py:2652`, `atlas_brain/api/b2b_campaigns.py:2683`, `atlas_brain/autonomous/tasks/b2b_campaign_generation.py:1543`, `atlas_brain/autonomous/tasks/b2b_campaign_generation.py:3841`, `tests/test_b2b_access_boundaries.py:577`, `tests/test_b2b_campaigns_api.py:403`, `tests/test_b2b_campaigns_api.py:545`, `tests/test_b2b_campaigns_api.py:573`, `tests/test_b2b_campaigns_api.py:606`, `tests/test_b2b_campaigns_api.py:642`, `tests/test_b2b_campaigns_api.py:672`, `tests/test_b2b_campaigns_api.py:703`, `tests/test_b2b_campaign_generation.py:1395` | Closed for campaign management route and campaign-id mutation boundaries. Every `b2b_campaigns.py` route now carries a B2B growth plan dependency; campaign list/detail/export/audit reads are scoped to tracked vendors; update/approve/queue/cancel/bulk writes include tracked-vendor ownership in their fetch/update paths; suppression state remains plan-gated. The `campaign_suppressions` table remains a global blocklist by design; future SYS-017 work should decide whether account-scoped suppression state is required. |
