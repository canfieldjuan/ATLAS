...
| SYS-021 | High | Campaign management access boundary | `b2b_campaigns.py` had a mixed boundary: some campaign management routes were plan-gated, while campaign list/stats/export/detail/audit-log, analytics, suppression state, review queues/candidates, and sequence controls were anonymous or optional-auth despite SaaS auth being enabled. The router now has zero optional/no-dependency routes; customer-facing campaign reads require `b2b_growth` and high-risk reads scope through tracked vendors before returning data. | `atlas_brain/api/b2b_campaigns.py:196`, `atlas_brain/api/b2b_campaigns.py:492`, `atlas_brain/api/b2b_campaigns.py:597`, `atlas_brain/api/b2b_campaigns.py:696`, `atlas_brain/api/b2b_campaigns.py:808`, `atlas_brain/api/b2b_campaigns.py:933`, `atlas_brain/api/b2b_campaigns.py:1004`, `atlas_brain/api/b2b_campaigns.py:1321`, `atlas_brain/api/b2b_campaigns.py:1661`, `atlas_brain/api/b2b_campaigns.py:1851`, `atlas_brain/api/b2b_campaigns.py:2261`, `atlas_brain/api/b2b_campaigns.py:2575`, `atlas_brain/api/b2b_campaigns.py:2606`, `atlas_brain/autonomous/tasks/b2b_campaign_generation.py:1543`, `atlas_brain/autonomous/tasks/b2b_campaign_generation.py:3841`, `tests/test_b2b_access_boundaries.py:577`, `tests/test_b2b_campaigns_api.py:403`, `tests/test_b2b_campaigns_api.py:476`, `tests/test_b2b_campaigns_api.py:506`, `tests/test_b2b_campaigns_api.py:826`, `tests/test_b2b_campaign_generation.py:1395` | Closed for route access boundary: every `b2b_campaigns.py` route now carries a B2B growth plan dependency, campaign list/detail/export/audit reads are scoped to the caller's tracked vendors, suppression state is plan-gated, and review/sequence surfaces enforce the same boundary. Follow-up is tenant-scope hardening on already plan-gated mutation paths such as update/approve/queue/cancel/bulk actions so writes cannot operate on out-of-account campaign ids. The `campaign_suppressions` table remains a global blocklist by design; future SYS-017 work should decide whether account-scoped suppression state is required. |
