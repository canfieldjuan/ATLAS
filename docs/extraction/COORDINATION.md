...
|---|---|---|---|---|---|
| `extracted_llm_infrastructure` | 2 (standalone toggle landed; Phase 3 decoupling pending) | #87 | #89 (PR-A2), #90 (PR-A1.5), #92 (PR-A3), #95 (PR-A4a) | Cost-closure additions (PR-A2 lift, PR-A1.5 cleanup, PR-A3 cache-savings, PR-A4a drift report, PR-A4b/c next) | `extracted_llm_infrastructure/services/cost/`, `extracted_llm_infrastructure/storage/migrations/259_*` |
...
| #95 | Add drift report (NEW CODE, PR-A4a) | `extracted_llm_infrastructure/{manifest.json, services/cost/__init__.py, services/cost/drift.py, README.md, STATUS.md}`; `tests/test_extracted_llm_infrastructure_drift.py`; `docs/extraction/COORDINATION.md` | claude-2026-05-03-b | `services/cost/drift.py` or related test/docs |
