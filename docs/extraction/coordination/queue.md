...
| PR-D6 | `extracted_content_pipeline` | codex-2026-05-03 | PR-D5 / #105 (merged); avoid PR-C1 files | Add a JSON/CSV-to-Postgres opportunity importer so hosts can load customer data into `campaign_opportunities` before running DB-backed generation. |
