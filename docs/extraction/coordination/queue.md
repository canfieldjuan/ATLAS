...
| PR-D5 | `extracted_content_pipeline` | codex-2026-05-03 | PR-D4 / #101 (merged); avoid PR-C1 files | Add a product-owned migration runner and CLI so hosts can apply copied campaign/content SQL without Atlas migration tooling. |
