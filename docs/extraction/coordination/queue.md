...
| PR-D1 | `extracted_content_pipeline` | codex-2026-05-03 | PR #78, PR #69 (both merged); avoid PR-C1 files | Document AI Content Ops reasoning handoff contract: content package consumes host-provided reasoning through `CampaignReasoningContextProvider`; reasoning generation stays in the reasoning product/host. |
