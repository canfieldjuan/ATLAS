...
Last updated: 2026-05-09T00:00Z by codex-content-ops-reasoning-catalog-status

Add a row before opening a PR (session protocol step 2). Drop the row when the PR merges (step 4). See [`../COORDINATION.md`](../COORDINATION.md) for protocol details.

| PR | Title | Touches | Owner | Don't conflict with |
|---|---|---|---|---|
| (in flight) | Expose Content Ops reasoning provider catalog status | EDIT: `extracted_content_pipeline/api/control_surfaces.py`; EDIT: `tests/test_extracted_content_control_surface_api.py`; EDIT: `atlas-intel-ui/src/api/contentOps.ts`; EDIT: `atlas-intel-ui/src/domain/contentOps/types.ts`; EDIT: `atlas-intel-ui/src/domain/contentOps/fromWire.ts`; EDIT: `atlas-intel-ui/src/api/__fixtures__/contentOps/catalog.json`; EDIT: `docs/frontend/content_ops_frontend_contract.md`; EDIT: `extracted_content_pipeline/docs/control_surface_preview_api.md` | codex-content-ops-reasoning-catalog-status | `extracted_competitive_intelligence/manifest.json`; `extracted_competitive_intelligence/autonomous/visibility.py`; `extracted_competitive_intelligence/storage/migrations/246_pipeline_visibility.sql` |
