...
|---|---|---|---|---|
| (in flight) | AI Content Ops control-surface execution readiness | EDIT: `extracted_content_pipeline/api/control_surfaces.py`, `extracted_content_pipeline/content_ops_execution.py`, control-surface tests/docs/status. | codex-2026-05-07-content-ops-readiness | Competitive-intelligence Phase 3 files; extracted reasoning-core migration files. |
