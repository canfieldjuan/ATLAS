...
|---|---|---|---|---|
| (in flight) | Document Content Ops reasoning execution smoke | EDIT: `extracted_content_pipeline/README.md`, `extracted_content_pipeline/docs/control_surface_preview_api.md`, `extracted_content_pipeline/docs/host_install_runbook.md`; NEW: `plans/PR-Content-Ops-Reasoning-Smoke-Docs.md`. | codex-content-ops-reasoning-smoke-docs | Avoid concurrent edits to Content Ops host smoke documentation. |
