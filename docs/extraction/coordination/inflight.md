...
|---|---|---|---|---|
| (in flight) | AI Content Ops landing-page and sales-brief parse retry parity | EDIT: `extracted_content_pipeline/landing_page_generation.py`, `extracted_content_pipeline/sales_brief_generation.py`, `extracted_content_pipeline/generation_plan.py`, related tests/status. | codex-2026-05-07-asset-retry | Competitive-intelligence Phase 3 files; extracted reasoning-core migration files. |
