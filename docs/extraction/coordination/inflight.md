...
|---|---|---|---|---|
| (in flight) | AI Content Ops execution provider contract hardening | EDIT: `extracted_content_pipeline/api/control_surfaces.py`, `tests/test_extracted_content_control_surface_api.py`. | codex-2026-05-07-content-ops-provider-contract | Competitive-intelligence Phase 3 files; extracted reasoning-core migration files. |
