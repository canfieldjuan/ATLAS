...
|---|---|---|---|---|
| (in flight) | Evidence-to-Story Stage 1 source loader foundation | NEW: `extracted_evidence_to_story/`; NEW: `scripts/build_evidence_to_story_sources.py`; NEW: `scripts/run_extracted_evidence_to_story_checks.sh`; NEW: `tests/test_extracted_evidence_to_story_sources.py`; MOVE: parked story docs and fixture from `extracted_content_pipeline/` into `extracted_evidence_to_story/`. | codex-2026-05-07-d34 | AI Content Ops runtime files; competitive-intelligence Phase 3 files; extracted reasoning-core migration files. |
