...
| (in flight) | AI Content Ops pure request validation | EDIT: `extracted_content_pipeline/control_surfaces.py`; `tests/test_extracted_content_control_surfaces.py` | codex-2026-05-08-request-validation | Avoid Content Ops pure `request_from_mapping` validation edits until this PR lands. |
