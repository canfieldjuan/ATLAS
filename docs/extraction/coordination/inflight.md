...
Last updated: 2026-05-10T23:17Z by codex-content-ops-db-reasoning-smoke
...
| (in flight) | Add DB-backed reasoning fixture to Content Ops execution smoke | EDIT: `scripts/smoke_extracted_content_ops_execution.py`; `tests/test_extracted_content_ops_execution_smoke.py`; `extracted_content_pipeline/README.md`; `extracted_content_pipeline/docs/host_install_runbook.md`; `docs/extraction/coordination/inflight.md`. NEW: `plans/PR-Content-Ops-DB-Reasoning-Smoke.md`. | codex-content-ops-db-reasoning-smoke | `extracted_competitive_intelligence/manifest.json`; `extracted_competitive_intelligence/autonomous/visibility.py`; `extracted_competitive_intelligence/storage/migrations/246_pipeline_visibility.sql` |
