...
|---|---|---|---|---|
| pending | Route Competitive Intelligence exact-cache bridge through extracted LLM infra | `extracted_competitive_intelligence/services/b2b/llm_exact_cache.py`; `extracted_competitive_intelligence/README.md`; `extracted_competitive_intelligence/STATUS.md`; `scripts/run_extracted_competitive_intelligence_checks.sh`; `scripts/smoke_extracted_competitive_intelligence_standalone.py`; `tests/test_extracted_competitive_llm_exact_cache_bridge.py` | codex-2026-05-04 | Competitive Intelligence LLM seam only; avoid Atlas reasoning state and content pipeline files |
