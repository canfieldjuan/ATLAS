...
|---|---|---|---|---|
| (in flight) | AI Content Ops campaign service parse-retry hardening | EDIT: `extracted_content_pipeline/campaign_generation.py`, `tests/test_extracted_campaign_generation.py`, docs/status/check runner if needed. | codex-2026-05-07-campaign-retry | Competitive-intelligence Phase 3 files; extracted reasoning-core migration files. |
