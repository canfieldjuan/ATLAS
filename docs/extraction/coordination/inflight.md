...
Last updated: 2026-05-09T20:50Z by codex-content-ops-sales-export
...
| (in flight) | Add read-only sales brief draft export helper for Content Ops | NEW: `extracted_content_pipeline/sales_brief_export.py`; `tests/test_extracted_sales_brief_export.py`; EDIT: `extracted_content_pipeline/sales_brief_generation.py`; docs/check wiring. | codex-content-ops-sales-export | Avoid sales brief export helper/tests/docs until PR closes. |
