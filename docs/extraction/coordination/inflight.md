...
Last updated: 2026-05-11T01:12Z by codex-content-ops-live-execute-smoke
...
| (in flight) | Add Content Ops live execute persistence smoke | NEW: `plans/PR-Content-Ops-Live-Execute-Smoke.md`; `tests/test_extracted_content_ops_live_execute_smoke.py`. EDIT: `scripts/run_extracted_pipeline_checks.sh`; `docs/extraction/coordination/inflight.md`. | codex-content-ops-live-execute-smoke | `extracted_competitive_intelligence/manifest.json`; `extracted_competitive_intelligence/autonomous/visibility.py`; `extracted_competitive_intelligence/storage/migrations/246_pipeline_visibility.sql` |
