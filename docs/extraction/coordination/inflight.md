...
|---|---|---|---|---|
| (in flight) | Add generated-asset reasoning usage counts for Content Ops services | EDIT: `extracted_content_pipeline/blog_generation.py`, `report_generation.py`, `landing_page_generation.py`, `sales_brief_generation.py` (result counters); matching tests; `docs/frontend/content_ops_frontend_contract.md`; NEW: `plans/PR-Content-Ops-Generated-Asset-Reasoning-Usage.md`. | codex-content-ops-generated-asset-reasoning-usage | Avoid concurrent edits to generated-asset result shapes and Content Ops reasoning usage reporting. |
