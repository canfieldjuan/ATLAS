...
|---|---|---|---|---|
| (in flight) | Add reasoning usage coverage to Content Ops execution smoke | EDIT: `scripts/smoke_extracted_content_ops_execution.py`, `tests/test_extracted_content_ops_execution_smoke.py`; NEW: `plans/PR-Content-Ops-Execution-Smoke-Reasoning.md`. | codex-content-ops-execution-smoke-reasoning | Avoid concurrent edits to the Content Ops execution smoke CLI and smoke tests. |
