...
| (in flight) | AI Content Ops parse-retry budget guard | EDIT: `extracted_content_pipeline/control_surfaces.py`; `extracted_content_pipeline/api/control_surfaces.py`; `tests/test_extracted_content_control_surfaces.py`; `tests/test_extracted_content_control_surface_api.py`; `extracted_content_pipeline/docs/control_surface_preview_api.md` | codex-2026-05-08-retry-budget | Avoid Content Ops control-surface preview/cost-estimate edits until this PR lands. |
