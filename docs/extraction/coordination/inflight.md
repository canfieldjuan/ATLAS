...
| (in flight) | AI Content Ops API hardening | EDIT: `extracted_content_pipeline/api/control_surfaces.py`; `tests/test_extracted_content_control_surface_api.py`; docs if request schema wording needs update | codex-2026-05-08-api-hardening | Avoid Content Ops control-surface API route edits until this PR lands. |
