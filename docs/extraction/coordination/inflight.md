...
| (in flight) | AI Content Ops post-merge cleanup | EDIT: `docs/extraction/coordination/inflight.md`; `tests/test_extracted_content_control_surface_api.py`; maybe `extracted_content_pipeline/api/control_surfaces.py` if sanitization is not applied on failed executions | codex-2026-05-08-post-merge-cleanup | Avoid Content Ops control-surface failure-status test/sanitization edits until this PR lands. |
