...
|---|---|---|---|---|
| pending | Add Competitive Intelligence PDF renderer standalone port | `extracted_competitive_intelligence/_standalone/pdf_renderer.py`; `extracted_competitive_intelligence/services/b2b/pdf_renderer.py`; `extracted_competitive_intelligence/README.md`; `extracted_competitive_intelligence/STATUS.md`; `scripts/run_extracted_competitive_intelligence_checks.sh`; `scripts/smoke_extracted_competitive_intelligence_standalone.py`; `tests/test_extracted_competitive_pdf_renderer_port.py` | codex-2026-05-04 | Competitive Intelligence gated report PDF renderer seam; avoid vendor briefing PDF adapter files |
