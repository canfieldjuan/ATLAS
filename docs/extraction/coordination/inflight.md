...
|---|---|---|---|---|
| (in flight) | AI Content Ops execution service contract hardening | EDIT: `extracted_content_pipeline/content_ops_execution.py`, `tests/test_extracted_content_ops_execution.py`. | codex-2026-05-07-content-ops-execution-contract | Competitive-intelligence Phase 3 files; extracted reasoning-core migration files. |
