...
| (in flight) | AI Content Ops signal extraction output | EDIT: `extracted_content_pipeline/control_surfaces.py`; `generation_plan.py`; `content_ops_execution.py`; source-adapter tests/docs | codex-2026-05-08-signal-extraction | Avoid `signal_extraction` control-surface/execution edits until this PR lands. |
