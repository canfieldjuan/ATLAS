...
| (in flight) | AI Content Ops signal extraction smoke | EDIT: `scripts/smoke_extracted_content_ops_execution.py`; `tests/test_extracted_content_ops_execution_smoke.py`; docs if needed | codex-2026-05-08-signal-smoke | Avoid Content Ops execution-smoke edits until this PR lands. |
