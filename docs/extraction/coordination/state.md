...
| `extracted_content_pipeline` | 1 -> 2 (productization seams) | #101 | — | Continue product-owned generation flows now that host reasoning and host prompt roots work on offline and DB-backed paths | none |
