...
| `extracted_content_pipeline` | 1 -> 2 (productization seams) | #190 | — | B2B campaign draft API seam landed; continue remaining host-facing API seam (`api/seller_campaigns.py`) after DB-backed review/export/send/progression/analytics/webhook paths | none |
