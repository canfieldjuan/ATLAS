...
Last updated: 2026-05-04T22:24Z by codex-content-seller-api-worker
...
| `extracted_content_pipeline` | 1 -> 2 (productization seams) | #194 | — | Host-facing B2B and seller API seams landed. Next decision: extract Amazon seller generation/category-intelligence producers behind ports, or continue hardening hosted worker seams. | none |
