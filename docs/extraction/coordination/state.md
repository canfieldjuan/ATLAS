...
| `extracted_competitive_intelligence` | 2 in progress (standalone toggle surfaces landing) | #129 | (pending) Own competitive cross-vendor selection surface | Continue Phase 2 ownership of standalone-ready product surfaces | `extracted_competitive_intelligence/reasoning/cross_vendor_selection.py`; competitive manifest/check wiring |
