...
| `extracted_competitive_intelligence` | 2 in progress (standalone toggle surfaces landing) | #139 | #145 | Continue Phase 2 ownership of standalone-ready product surfaces | `extracted_competitive_intelligence/reasoning/single_pass_prompts/*`; competitive manifest/check wiring |
