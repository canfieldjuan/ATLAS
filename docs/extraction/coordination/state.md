...
| `extracted_content_pipeline` | 1 -> 2 (productization seams) | #175 | — | Continue remaining campaign orchestration/API seams after DB-backed review/export/send/progression/analytics/webhook paths landed | none |
