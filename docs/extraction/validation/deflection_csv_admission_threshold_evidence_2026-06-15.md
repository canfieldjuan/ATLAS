...
|---|---|---|---|---:|---:|---|---:|
| unknown_body_like_column_rejects_zero_usable | ok | REJECT | REJECT | 1 | 0 | REJECT | 0 |
| private_note_only_rejects_zero_usable | ok | REJECT | REJECT | 1 | 0 | REJECT | 0 |
| status_timestamp_only_rejects_zero_usable | ok | REJECT | REJECT | 1 | 0 | REJECT | 0 |
