...
1. Open Analytics then Attribution then click Download report.
...
- `zd-4101` - Attribution export blocked: "How do I export attribution reports before our board meeting?"
- `zd-4102` - Report download missing: "Where is the report download for attribution exports?"
- `fd-4103` - Dashboard export permissions: "Why can analysts view dashboards but not export reports?"
