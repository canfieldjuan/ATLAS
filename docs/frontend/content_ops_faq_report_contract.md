...
The deflection report and Snapshot examples are generated by
`scripts/generate_deflection_snapshot_example.py` from fabricated support-ticket
records. Public landing demos should consume those generated artifacts rather
than maintaining parallel hand-authored report/snapshot fixtures.
