...
Use the `intelligence/autonomous_narrative_architect` agent after the simulator (`intelligence/simulated_evolution`, available in the skill registry) to design narrative micro-interventions that stabilize the environment. The agent outputs parallel narrative design, micro-intervention plans, and a first intervention definition scoped to the hours-before-event window.
