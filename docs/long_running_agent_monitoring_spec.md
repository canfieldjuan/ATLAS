...
| Review finding classes | Codex connector findings grouped by verdict, rule ID, and root class. | Review threads, PR review bodies, live reconciliation output | Converts review misses into durable prevention work. |
