...
export function toWeeklyChurnFeedItems(value: unknown): WeeklyChurnFeedItemViewModel[] {
  const items = Array.isArray(value)
    ...
    account_pressure_disclaimer: asString(item.account_pressure_disclaimer),
    account_actionability_tier: asString(item.account_actionability_tier),
...
export function toBattleCardViewModel(value: UnknownRecord): BattleCardViewModel {
  ...
  return {
    ...
    account_pressure_disclaimer: asString(value.account_pressure_disclaimer),
    account_actionability_tier: asString(value.account_actionability_tier),
