...
<p><strong>Pricing</strong> generates significant negative sentiment, particularly around unexpected charges and billing complexity.</p>
<p>One reviewer reported a $400 charge for a barely-used QuickSight dashboard, with a support request left unassigned for over three weeks — illustrating how billing unpredictability compounds support frustration.</p>
