...
<p>The available counterevidence suggests some teams see ROI from Power BI despite considering Tableau. The source data limits interpretation, but the fact that Tableau was evaluated and rejected indicates Power BI's Microsoft integration creates enough value to offset Tableau's UX and performance advantages for some buyers.</p>
