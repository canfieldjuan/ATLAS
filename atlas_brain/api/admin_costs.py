...
async def scraping_summary(days: int = Query(default=7, ge=1, le=30)):
    ...
    return {
        ...
        "today": {
            "runs": int(_record_value(today_row, "runs_today", 0) or 0),
            "reviews_inserted": int(_record_value(today_row, "inserted_today", 0) or 0),
            "errors": int(_record_value(today_row, "errors_today", 0) or 0),
            "saved_calls": int(_record_value(today_row, "saved_calls_today", 0) or 0),
        },
