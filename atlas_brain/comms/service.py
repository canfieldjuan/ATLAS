...
from .config import comms_settings, BusinessContext, EFFINGHAM_MAIDS_CONTEXT
...
class CommsService:
    ...
    async def start(self) -> bool:
        ...
        try:
            ...
            # Pre-cache greetings for instant playback
            from .phone_processor import warm_greeting_cache
            contexts = self._context_router.list_contexts()
            await warm_greeting_cache(contexts)
    ...
    async def stop(self) -> None:
        ...
        # Close scheduling service
        await scheduling_service.close()
