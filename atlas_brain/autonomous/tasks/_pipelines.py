...
register_pipeline(PipelineConfig(
    ...
    tasks=[
        ...
        TaskDef(
            ...
            description="Core churn intelligence: data fetch, reasoning, signal persistence",
            metadata={
        ...
        TaskDef(
            ...
            module="b2b_reasoning_synthesis",
            schedule_type="cron",
        ...
        TaskDef(
            ...
            module="b2b_churn_reports",
            schedule_type="cron",
            cron_expression="30 21 * * *",
            timeout_seconds=600,
            description="Build and persist churn intelligence reports from persisted signals",
            metadata={"builtin_handler": "b2b_churn_reports"},
            cron_config_key="b2b_churn.reports_cron",
        ),
        TaskDef(
            name="b2b_battle_cards",
            module="b2b_battle_cards",
            schedule_type="cron",
            cron_expression="30 21 * * *",
            timeout_seconds=900,
            description="Build and LLM-enrich battle cards per vendor from persisted signals",
            metadata={"builtin_handler": "b2b_battle_cards"},
        ...
        TaskDef(
            ...
            cron_expression="35 21 * * *",
            timeout_seconds=120,
            description="Correlate news articles with vendor churn archetypes",
            metadata={"builtin_handler": "b2b_article_correlation"},
