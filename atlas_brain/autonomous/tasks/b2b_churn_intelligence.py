...
async def _fetch_company_signal_review_context(
    ...
    if not review_ids:
        return {}
    # APPROVED-ENRICHMENT-READ: competitors_mentioned, quotable_phrases, feature_gaps, timeline.evaluation_deadline, timeline.decision_timeline, contract_context.contract_value_signal, reviewer_context.industry
    # Reason: Feeds pool builders for company signal context; reads by review ID, not ad-hoc scan
