...
def _render_email(
    ...
    *,
    ...
    if milestone == "day_3":
        subject = "Get started with Atlas Intel"
        body = (
            f"<h2>Welcome to Atlas Intel</h2>"
            f"<p>Hi {name},</p>"
            f"<p>You signed up for Atlas Intel 3 days ago but haven't tracked any ASINs yet.</p>"
            f"<p>Start by adding your first ASIN to get competitive intelligence, "
            f"pain-point analysis, and safety alerts delivered straight to your inbox.</p>"
            f"<p><a href='{base_url}/dashboard' "
            f"style='display:inline-block;padding:10px 24px;background:#2563eb;"
            f"color:#fff;text-decoration:none;border-radius:6px;'>Add Your First ASIN</a></p>"
            f"<p>You have {trial_days_left} days left in your trial.</p>"
        )
    elif milestone == "day_7":
        subject = "Your week 1 intel summary"
        body = (
            f"<h2>Your First Week with Atlas Intel</h2>"
            f"<p>Hi {name},</p>"
            f"<p>You're one week into your trial"
            f"{f' and tracking {asin_count} ASIN(s)' if asin_count else ''}. "
            f"Here's what Atlas Intel can do for you:</p>"
            f"<ul>"
            f"<li><strong>Pain-point analysis</strong> - Know exactly what customers complain about</li>"
            f"<li><strong>Competitive flows</strong> - See which brands customers switch to and from</li>"
            f"<li><strong>Safety alerts</strong> - Get notified about product safety concerns instantly</li>"
            f"<li><strong>Feature gap mapping</strong> - Discover unmet needs in your category</li>"
            f"</ul>"
            f"<p><a href='{base_url}/dashboard' "
            f"style='display:inline-block;padding:10px 24px;background:#2563eb;"
            f"color:#fff;text-decoration:none;border-radius:6px;'>View Your Dashboard</a></p>"
            f"<p>You have {trial_days_left} days left in your trial.</p>"
        )
        ...
        body = (
            f"<h2>3 Days Left</h2>"
            f"<p>Hi {name},</p>"
            f"<p>Your Atlas Intel trial for <strong>{account_name}</strong> ends in 3 days.</p>"
            f"<p>Upgrade now to keep your tracked ASINs, alerts, and competitive intelligence flowing:</p>"
            f"<ul>"
            f"<li><strong>Starter</strong> ($99/mo) - 10 ASINs, weekly digests</li>"
            f"<li><strong>Growth</strong> ($199/mo) - 50 ASINs, API access, brand comparisons</li>"
        ...
        body = (
            ...
            f"<p>After expiration, you'll lose access to:"
            f"<ul>"
            f"<li>Tracked ASIN intelligence</li>"
            f"<li>Signal alerts and weekly digests</li>"
            f"<li>Brand comparisons and competitive flows</li>"
            f"</ul>"
