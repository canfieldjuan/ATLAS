...
**Over the 400 LOC budget, deliberately.** The diff is 4162 diff lines, of
which 2203 are tests and 685 are this plan. Runtime code is 1202 lines
across three files.
...
| File | +/- |
|---|---:|
| `tests/test_codex_wake_run.py` | +1830 |
| `scripts/codex_wake_run.py` | +1178 |
| `plans/PR-Codex-Thread-Resume-Wake.md` | +685 |
