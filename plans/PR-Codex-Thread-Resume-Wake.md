...
**Over the 400 LOC budget, deliberately.** The diff is 3327 diff lines, of
which 1692 are tests and 574 are this plan. Runtime code is 989 lines
across three files.
...
| File | +/- |
|---|---:|
| `tests/test_codex_wake_run.py` | +1319 |
| `scripts/codex_wake_run.py` | +965 |
| `plans/PR-Codex-Thread-Resume-Wake.md` | +574 |
