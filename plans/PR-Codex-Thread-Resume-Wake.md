...
**Over the 400 LOC budget, deliberately.** The diff is 4026 diff lines, of
which 2113 are tests and 666 are this plan. Runtime code is 1175 lines
across three files.
...
| File | +/- |
|---|---:|
| `tests/test_codex_wake_run.py` | +1740 |
| `scripts/codex_wake_run.py` | +1151 |
| `plans/PR-Codex-Thread-Resume-Wake.md` | +666 |
