...
**Over the 400 LOC budget, deliberately.** The diff is 2482 diff lines, of
which 1314 are tests and 470 are this plan. Runtime code is 631 lines
across three files.
...
| `scripts/codex_wake_run.py` | +607 |
| `plans/PR-Codex-Thread-Resume-Wake.md` | +470 |
