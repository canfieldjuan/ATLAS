...
**Over the 400 LOC budget, deliberately.** The diff is 2256 diff lines, of
which 1184 are tests and 410 are this plan. Runtime code is 607 lines
across three files.
...
| File | +/- |
|---|---:|
| `tests/test_codex_wake_run.py` | +810 |
| `scripts/codex_wake_run.py` | +583 |
| `plans/PR-Codex-Thread-Resume-Wake.md` | +410 |
| `tests/test_codex_wake_end_to_end.py` | +239 |
