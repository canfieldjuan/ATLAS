...
**Over the 400 LOC budget, deliberately.** The diff is 2301 diff lines, of
which 1207 are tests and 428 are this plan. Runtime code is 606 lines
across three files.
...
| File | +/- |
|---|---:|
| `tests/test_codex_wake_run.py` | +837 |
| `scripts/codex_wake_run.py` | +582 |
| `plans/PR-Codex-Thread-Resume-Wake.md` | +428 |
