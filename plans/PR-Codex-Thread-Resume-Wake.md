...
**Over the 400 LOC budget, deliberately.** The diff is 2242 diff lines, of
which 1088 are tests and 400 are this plan. Runtime code is 699 lines
across three files.
...
| File | +/- |
|---|---:|
| `tests/test_codex_wake_run.py` | +953 |
| `scripts/codex_wake_run.py` | +675 |
| `plans/PR-Codex-Thread-Resume-Wake.md` | +400 |
