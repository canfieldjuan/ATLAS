...
**Over the 400 LOC budget, deliberately.** The diff is 3263 diff lines, of
which 1638 are tests and 570 are this plan. Runtime code is 983 lines
across three files.
...
| File | +/- |
|---|---:|
| `tests/test_codex_wake_run.py` | +1265 |
| `scripts/codex_wake_run.py` | +959 |
| `plans/PR-Codex-Thread-Resume-Wake.md` | +570 |
