...
**Over the 400 LOC budget, deliberately.** The diff is 3177 diff lines, of
which 1592 are tests and 553 are this plan. Runtime code is 965 lines
across three files.
...
| File | +/- |
|---|---:|
| `tests/test_codex_wake_run.py` | +1219 |
| `scripts/codex_wake_run.py` | +941 |
| `plans/PR-Codex-Thread-Resume-Wake.md` | +553 |
