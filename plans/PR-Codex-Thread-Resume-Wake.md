...
**Over the 400 LOC budget, deliberately.** The diff is 3106 diff lines, of
which 1552 are tests and 532 are this plan. Runtime code is 955 lines
across three files.
...
| File | +/- |
|---|---:|
| `tests/test_codex_wake_run.py` | +1179 |
| `scripts/codex_wake_run.py` | +931 |
| `plans/PR-Codex-Thread-Resume-Wake.md` | +532 |
