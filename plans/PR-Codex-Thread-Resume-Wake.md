...
**Over the 400 LOC budget, deliberately.** The diff is 2845 diff lines, of
which 1466 are tests and 518 are this plan. Runtime code is 794 lines
across three files.
...
| File | +/- |
|---|---:|
| `tests/test_codex_wake_run.py` | +1093 |
| `scripts/codex_wake_run.py` | +770 |
| `plans/PR-Codex-Thread-Resume-Wake.md` | +518 |
