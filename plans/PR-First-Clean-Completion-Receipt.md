...
place, rejects a live former-guard session in the target database before any
ownership transfer, rejects every direct or inherited guard path held by a non-superuser login,
